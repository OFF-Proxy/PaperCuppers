...
async function OnMessage(event){
    ...
    while(offset < byte_array.byteLength){
        ...
        if(type == RESPONSE_COORDINATE_LIST){
        ...
        if(type == INSTRUCT_PIECE_PICKING){
        ...
        if(type == INSTRUCT_PIECE_PLACEMENT){
